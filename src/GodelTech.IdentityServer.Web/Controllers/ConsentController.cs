...
using GodelTech.IdentityServer.Web.Configuration.Consent;
using GodelTech.IdentityServer.Web.Models.Consent;
...
namespace GodelTech.IdentityServer.Web.Controllers
{
    ...
    public class ConsentController : Controller
    {
        ...
        {
            var buildViewModel = await BuildViewModelAsync(returnUrl);
